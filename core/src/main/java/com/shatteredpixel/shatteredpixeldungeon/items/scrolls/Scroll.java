...
public abstract class Scroll extends Item {
	...
	private static final LinkedHashMap<String, Integer> runes = new LinkedHashMap<String, Integer>() {
		{
            ...
            put("ZYCHRON",ItemSpriteSheet.SCROLL_ZYCHRON);
			put("CREUCH",ItemSpriteSheet.SCROLL_CREUCH);
		}
	};
	...
	public void execute( Hero hero, String action ) {
		...
		if (action.equals( AC_READ )) {
            ...
            } else if (hero.buff(ExaminationParchment.questionnaireEnergy.class) != null &&
                    hero.buff(ExaminationParchment.questionnaireEnergy.class).isCursed()
                    && !(this instanceof ScrollOfRemoveCurse || this instanceof ScrollOfAntiMagic)) {
                GLog.n(Messages.get(this, "exam_cursed"));
            } else {
				doRead();
				Tasks.onScrollRead();
	...
	public static class ScrollToStone extends Recipe {
		...
		static {
            ...
            stones.put(ScrollOfPower.class,       StoneOfEmpowerment.class);
		}
