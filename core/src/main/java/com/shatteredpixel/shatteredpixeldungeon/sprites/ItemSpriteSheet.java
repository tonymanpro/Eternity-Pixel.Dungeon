...
public class ItemSpriteSheet {
	...
	public static final int DARK_RUNIC      = WEP_TIER5+7;
	static{
		...
		assignItemRect(DARK_RUNIC,  14, 14);
	}
	...
	public static final int ARMOR_CLERIC    = ARMOR+11;
	static{
    ...
    public static final int ELIXIR_DI   = BREWS+6;
	...
	static{
		...
		assignItemRect(CHEESE_CHUNK,	10, 8);
	}
    ...
    public static final int PORTABLE_SHOP  = SPELLS_NEW_ROW+7;
	...
	public static final int POWERLESS  = SPELLS_NEW_ROW+13;
	static {
        ...
        assignItemRect(PORTABLE_SHOP,    	 12, 12);
		...
		assignItemRect(POWERLESS,    	 12, 12);
	}
