...
public class VaultMob extends Mob {
	...
	public class Wandering extends Mob.Wandering {
		...
		protected float detectionChance( Char enemy ){
			...
			float movementDir = PointF.angle(new PointF(Dungeon.level.cellToPoint(previousPos)), new PointF(Dungeon.level.cellToPoint(pos)))/PointF.G2R;
			float enemyDir = PointF.angle(new PointF(Dungeon.level.cellToPoint(pos)), new PointF(Dungeon.level.cellToPoint(enemy.pos)))/PointF.G2R;
