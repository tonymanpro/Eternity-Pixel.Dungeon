...
public class ShadowClone extends ArmorAbility {
	...
	public static class ShadowAlly extends DirectableAlly {
		...
		public long damageRoll() {
			long damage = Dungeon.NormalLongRange(10, 20);
		...
		public boolean isImmune(Class effect) {
            ...
            if ((effect == Frost.class || effect == Chill.class)
                    && Random.Int(4) < Dungeon.hero.pointsInTalent(Talent.CLONED_ARMOR)
                    && Dungeon.hero.belongings.armor() != null
                    && Dungeon.hero.belongings.armor().hasGlyph(Frostbite.class, this)){
                return true;
            }
		...
		public long defenseProc(Char enemy, long damage) {
			...
			if (Random.Int(4) < Dungeon.hero.pointsInTalent(Talent.CLONED_ARMOR)
					&& Dungeon.hero.belongings.armor() != null){
				return (int) Dungeon.hero.belongings.armor().proc( enemy, this, damage );
			} else {
				return damage;
			}
		}
