...
public class PowerOfMany extends ArmorAbility {
	...
	public static class LightAlly extends DirectableAlly {
		...
		public long damageRoll() {
			return Random.NormalLongRange(5, 30); //+0 greatsword
		}

		@Override
		public long drRoll() {
			return super.drRoll() + Random.NormalLongRange(1, 5); //+0 plate
		}
	...
	public static class LightAllySprite extends MobSprite {
		...
		public void setup(HeroClass cls){
			...
			TextureFilm film = new TextureFilm( HeroSprite.tiers(cls.spritesheet(), 15), 6, 12, 15 );
