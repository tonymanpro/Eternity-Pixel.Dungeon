...
public enum Catalog {
	...
	static {
        ...
        THROWN_WEAPONS.addItems(ShurikenOfShadows.class);
		...
		MISC_EQUIPMENT.addItems(BrokenSeal.class, SpiritBow.class, Waterskin.class, VelvetPouch.class,
				...
				CheeseCheest.class, UtilityBag.class, Blueprint.class);
		...
		BREWS_ELIXIRS.addItems( UnstableBrew.class, InfernalBrew.class, BlizzardBrew.class,
                ...
                ElixirOfDivineInspiration.class);
		...
		SPELLS.addItems( UnstableSpell.class, WildEnergy.class, TelekineticGrab.class, PhaseShift.class,
                ...
                GalacticInfusion.class, Barricade.class, DeterminantInfusion.class, PocketAlchemy.class,
                TierUpgrade.class, ArmorTierUpgrade.class, Powerless.class, ItemGetter.class);
